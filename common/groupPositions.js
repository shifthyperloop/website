const groups = [
    ...
    positions: [
      {
        ...
        description:
          'The electromagnetic simulation engineer understands the electromagnetic interaction between the levitation system and the track, and drives the development of new levitation system concepts for the group to evaluate. She/he will also evaluate system performance using FEM analysis and develop performance models.',
      },
      {
        name: 'Sensor engineer',
        description:
          'The Levitation R&D sensor engineers are responsible for acquisition of sensor data when testing levitation designs. The main tasks will be choice of sensors, circuit design, integration with the test setup and data analysis.',
      },
      {
        name: 'Mechanical engineer',
        description:
          'The Levitation R&D mechanical engineers are responsible for designing the mechanical test aspects to further develop the organizations levitation knowledge.',
      },
    ],
  },
  {
    name: 'Powertrain',
    description:
      'The powertrain group consists of the systems necessary for the pod to move. This group works closely with the battery group to maximize propulsive power. You will collaborate with members from various studies and backgrounds in order to complete the task.',
    image: 'powertrain.jpg',
    positions: [
      {
        name: 'Group leader',
        description:
          "The powertrain lead will manage the group's progress and accomplishments. It is a unique opportunity to manage a group responsible for one of the most defining principles for the hyperloop concept; magnetic propulsion.",
      },
      {
        name: 'Motor Design & Production',
        description:
          'The motor design engineer designs the Linear AC induction motor and experiments with different production methods. This position consists of mostly prototyping. ',
      },
      {
        name: 'Power Electronics',
        description:
          'The power electronics engineer designs the high voltage power systems. Their goal is to optimize the power capabilities of the battery pack, inverter, and the rest of the high voltage electrical components.',
      },
      {
  ...
  },
  {
    ...
    description:
      'The electronics group is responsible for developing several of the embedded systems on the pod, this includes data acquisition, communication and control systems. Members of the group will work a lot with PCB design and software development.',
    image: 'electronics.jpg',
    positions: [
      {
        name: 'Sensors engineer',
        description:
          'The sensors engineers will be responsible for developing all sensor systems needed to acquire the data used to operate the pod. Reliable and accurate data is important for maximum performance. One challenge is how to precisely determine the position of the pod on the track.',
      },
      {
        name: 'Telemetry engineer',
        description:
          'The telemetry engineers will work on reliable wireless communication for the pod. Working closely with the software group, the telemetry engineers will develop a communication link between the pod and the engineers operating the pod.',
      },
      {
        name: 'Vehicle Control Engineer',
        description:
          'The Vehicle Control Engineers will be responsible for developing the Vehicle Control Unit (VCU), which through sensor data and telemetry communication controls the pods actions.',
      },
      {
        name: 'Motor controller embedded engineer',
        description:
          'The motor controller engineers will work together with the motor control algorithm engineers to design and implement the control algorithm for the inverter.',
      },
      {
        name: 'BMS engineer',
        description:
          'The BMS engineers will be responsible for developing a battery management system. Lithium-ion batteries are extremely volatile. This advanced control system is critical for preventing the battery pack from acting outside its safe operating area, drastically reducing the hazard presented by the high density energy storage system.',
      },
    ],
  },
  {
    ...
    positions: [
      {
        name: 'Group leader',
        description:
          'The software lead will manage the groups progress and accomplishments, however the software lead is much more involved in the day to day development work compared to the other groups..',
      },
      {
        name: 'CAN software engineer',
        description:
          'The CAN software engineers will develop a system for defining data structures in a common format across different data-architectures. You will work closely with the embedded electronics group as well as the software group.',
      },
      {
        name: 'Software engineer',
        description:
          'The software engineers will work on further development of the base operator application. You will work closely with the sensors engineers and the BMS engineers among others, to display critical pod-values to the operator.',
      },
    ],
  },
  {
    ...
    positions: [
      ...
      },
      {
        name: 'Suspension',
        description:
          'The suspensions engineers will design a dampening system to reduce vibrations and shock to ensure that the Pod can withstand a high speed run. You will work closely with chassis on placements, geometry and force distribution.',
      },
      {
        name: 'Chassis',
        description:
          'The chassis engineers will be responsible for designing a chassis, which will function as the back bone of the pod. You will also be responsible of assembling every sub system onto the chassis to complete the pod. ',
      },
      {
        name: 'Brakes',
        description:
          'The brake engineers will engineer a braking system which fits the track geometry with a goal to stop for high speeds as efficiently as possible. The braking force will be the largest sustained force to deal with, so you will be working closely with chassis to distribute them.',
      },
    ],
  },
  {
    ...
    positions: [
      {
        name: 'Aeroshell',
        description:
          'The Aeroshell designers will design a fiber composites structure which will be the outline and the aesthetic part of the Pod. ',
      },
      {
        name: 'Power systems casing',
        description:
          'The casing engineers are responsible for designing the battery casing, inverter casing and to house electrical components.',
      },
    ],
  },
  {
    ...
    positions: [
      ...
      },
      {
        ...
        description:
          'As the writer in Shift you will be responsible for writing the social media posts, as well as the newsletters. You will be working with the graphical designer to make sure Shift looks its best from the outside.\n\nThis is a very independent role, and you will have much freedom to figure out what you want to write about!  You will communicate a lot with the other groups in Shift in order to get an overview into what is currently happening in Shift.',
      },
      {
        name: 'Video and/or photo Editor',
        description:
          'The main part of this job is filming and editing videos that is needed in Shift. We hope to produce a couple of cool videos throughout next year. One of the main things that we would like to produce is a proper hype video that will really get people excited for Shift Hyperloop!\n\nWe also need someone to edit and take pictures of the group! We need people to take profile pictures, group photos and photos of whatever things that come up throughout the year.',
      },
    ],
  },
  {
