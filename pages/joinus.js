        ...
        <div className="groups">
          <div className="board group left">
            ...
            <div className="group-info">
              ...
              <p>
                {' '}
                Management is responsible for deciding strategy for the whole organisation.
          ...
          <div className="board group right">
            <div className="group-info">
              ...
              <p>
                ...
                sure that the organisation follows the guidelines set by the board.
                They also do the administrative work for the organisation.
